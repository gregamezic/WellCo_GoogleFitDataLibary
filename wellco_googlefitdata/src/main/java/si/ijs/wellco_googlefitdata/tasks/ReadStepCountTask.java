...
public class ReadStepCountTask extends AsyncTask<Long, Void, Void> {

    private final String TAG = ReadStepCountTask.class.getName();

    public OnStepCountResult listener;
    ...
    private void readDataResult(DataReadResult dataReadResult) {
        ...
        Log.d(TAG, "readDataResult: Total step count: " + stepCount);

        listener.onStepCountResult(stepCount);
    }
}
