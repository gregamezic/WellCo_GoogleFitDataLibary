...
public class ReadDistanceTask extends AsyncTask<Long, Void, Void> {

    private final String TAG = ReadStepCountTask.class.getName();

    public OnDistanceDataResult listener;
    ...
    private void readDataResult(DataReadResult dataReadResult) {
        ...
        Log.d(TAG, "readDataResult: Total distance time: " + distance);

        listener.onDistanceResult(distance);
    }
}
